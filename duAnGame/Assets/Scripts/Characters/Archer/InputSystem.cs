...
public class InputSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            characterC.Move(new Vector3(transform.position.x, transform.position.y - gravityValue, transform.position.z));
        }
        ...
        if (isAiming)
        {
            ...
            if (Input.GetButtonUp(input.fire))
            {
                ...
                {
                    bowScript.Fire(ray.GetPoint(200f));
                }
            }
