...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        {
            _animator.SetBool(animationStrings.aim, aiming);
        }
        public void CharacterPullString(bool pull)
        {
            _animator.SetBool(animationStrings.pull, pull);
        }
        ...
        /*public void Shoot()
        {
            GameObject arrow = Instantiate(arrowPrefabs, arrowPoint.position, transform.rotation);
