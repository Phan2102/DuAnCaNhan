...
public class Bow : MonoBehaviour
{
    ...
    public class BowSettings
    {
        ...
        [Header("Bow Equip & UnEuip Settings")]
        ...
        public Transform stringHandPullPoss;
    ...
    {
        bowSettings.bowString.transform.position = bowSettings.stringHandPullPoss.position;
        bowSettings.bowString.transform.parent = bowSettings.stringHandPullPoss;
    }
